...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('employee_images', sa.Column('file_id', sa.VARCHAR(), autoincrement=False, nullable=False))
    op.add_column('employee_images', sa.Column('full_name', sa.VARCHAR(), autoincrement=False, nullable=False))
